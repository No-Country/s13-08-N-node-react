        ...
        <div className="h-[100vh] pt-40 bg-bgGreen text-darkBlue">
            ...
            <form className='mt-14 px-7 flex flex-col gap-y-4'>
                <div className='flex flex-col'>
                    <label htmlFor="" className="text-sm mb-2">Nombre del premio</label>
                    <input type="text" placeholder='' className="p-2 rounded-[10px]"/>
                </div>
                <div className='grid grid-cols-2 gap-x-5'>
                    <div className='flex flex-col'>
                        <label htmlFor="" className="text-sm mb-2">Fecha de inicio</label>
                        <input type="text" placeholder='' className="p-2 rounded-[10px]"/>
                    </div>
                    <div className='flex flex-col'>
                        <label htmlFor="" className="text-sm mb-2">Fecha de finalización</label>
                        <input type="text" placeholder='' className="p-2 rounded-[10px]"/>
                    </div>
                </div>
                <div className='flex flex-col'>
                    <label htmlFor="" className="text-sm mb-2">Cantidad de puntos asignados</label>
                    <input type="text" placeholder='' className="p-2 rounded-[10px]"/>
                </div>
                <div className='flex flex-col'>
                    <label htmlFor="" className="text-sm mb-2">Lugar de canjeo</label>
                    <input type="text" placeholder='' className="p-2 rounded-[10px]"/>
                </div>
