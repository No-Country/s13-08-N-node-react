            ...
            <div className='flex flex-col gap-y-1'>
                ...
                {hidePoints ? 
                    <div className='flex justify-between'>
                        ...
                        <button onClick={() => setHidePoints(!hidePoints)} className='bg-black text-white px-4 rounded-lg'>Canje</button>
                    </div>
                    : 
                    <div className='flex justify-between'>
                        <p className='text-base flex items-center gap-x-1'><span className='text-xl'><BsTicketPerforated /></span>#12514</p>
                        <button onClick={() => setHidePoints(!hidePoints)} className='border border-black text-black px-4 rounded-lg'>Canjeado</button>
                    </div>
                }
            </div>
        </div>
